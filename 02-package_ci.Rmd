...
knitr::include_graphics("images/actions_panel.png")
```
...
```{r, eval = TRUE, echo = FALSE}
knitr::include_graphics("images/actions_panel2.png")
```
...
```{r, eval = TRUE, echo = FALSE}
knitr::include_graphics("images/rcmd_check_status.png")
```

```{r, eval = TRUE, echo = FALSE}
knitr::include_graphics("images/create_badge.png")
```
