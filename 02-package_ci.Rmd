...
If you already have a package you can instead follow either of these instructions to set it up with GitHub,: 
[Existing project and package, GitHub first](https://happygitwithr.com/existing-GitHub-first.html#existing-GitHub-first) or 
[Existing project and package, GitHub last](https://happygitwithr.com/existing-GitHub-last.html#existing-GitHub-last). 

## Specify GitHub links
